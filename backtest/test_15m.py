"""
15m TIMEFRAME OPTIMIZATION - Parallel test
"""
import sys
...
DATA = {}
for asset, file in FILES_15M.items():
    path = DATA_DIR / file
    if path.exists():
        try:
...
if __name__ == '__main__':
    ...
    print(f"\n{'='*60}", flush=True)
    print(f"TIMEFRAME: 15m", flush=True)
    ...
    if 'results' in best:
        ...
        for asset in sorted(FILES_15M.keys()):
